...
### 🔧 Changed
- **The drifted-clock Repairs notice now points at the Time Drift sensor**, so you can see the exact offset in seconds and confirm it returns to `0 s` after pressing **Sync Time**.
