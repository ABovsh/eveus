...
- **Показники станції:** напруга, струм, потужність, температури та заземлення; для трифазного підключення — струм і напруга кожної фази.
- **Керування заряджанням:** струм, зупинка, одноразове заряджання, два розклади й адаптивний режим.
- **Енергія та вартість:** поточна й остання сесії, загальне споживання, лічильники A/B і тарифи станції.
- **Оцінка заряду авто:** SOC, час, енергія та вартість до цільового рівня; зупинка за SOC у Розширеному режимі.
- **Автоматизації та сповіщення:** тригери пристрою, події, готові проекти автоматизацій і сповіщення про несправності.

Можна додати кілька станцій; кожна матиме окремий пристрій і набір сутностей.
Інтерфейс інтеграції та картки доступний українською й англійською.
