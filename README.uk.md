...
|---|---|---|
| `compact` | Один рядок: стан, заряд · потужність · час до цільового заряду · енергія сесії · вартість, смужка заряду внизу | — |
...
- **Смужка заряду.** У Розширеному режимі смужка під плитками заповнюється від
  початкового до поточного заряду; рисочки позначають початковий і цільовий
  заряд. Помаранчева позначка на повзунку **Струм заряджання** показує
