...
- **Керування:** натискання на показник відкриває сутність. Довге натискання на плитку батареї відкриває **Початковий SOC**, на плитку цілі — **Цільовий SOC**. Для зупинки активного заряджання натисніть **Стоп** повторно протягом чотирьох секунд. Збільшення струму теж потребує підтвердження: натисніть на нове значення протягом чотирьох секунд, щоб застосувати його; зменшення застосовується одразу. Скидання лічильника картка перепитує. У **Розкладах** натисніть на час, щоб вибрати новий, на значок ліміту — щоб увімкнути чи вимкнути його, а на значення — щоб ввести нове. Значок розкладу світиться, поки розклад діє.
