...
- **Керування:** натискання на показник відкриває сутність. Довге натискання на **Заряд**, **До цілі** або **Струм** відкриває відповідне налаштування. Для зупинки активного заряджання натисніть повторно протягом чотирьох секунд.
