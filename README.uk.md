...
![Версія](https://img.shields.io/badge/version-4.25.0-blue?style=for-the-badge)
...
<p align="center">
  ...
  <img alt="Редактор картки Eveus — розділи, які можна вибрати й упорядкувати" src="docs/images/card-editor-en.jpg" width="49%">
</p>

> [!IMPORTANT]
> **Оновлюєтеся з 4.24.0 або старішої версії? Додайте картку Eveus заново.** Картку перероблено, і вже додана картка не отримує нових розділів. [Як це зробити →](#картка-eveus)
...
> [!WARNING]
> **Оновлюєтеся з 4.24.0 або старішої версії? Додайте картку заново.** Картку перероблено, а раніше додана картка показує лише розділи свого старого макета, без Розкладів і Годинника станції.
> 1. Відкрийте панель → **Редагувати панель**.
> 2. Видаліть кожну картку Eveus.
> 3. **Додати картку → Eveus EV Charger**, позначте потрібні розділи й натисніть **Зберегти**.
...
заряду** враховує втрати. **Вартість до цільового заряду** під час заряджання
рахує кожну частину енергії за тарифом того вікна, на яке вона припадає, а без
заряджання — за поточним тарифом. Саме встановлення цільового SOC не зупиняє заряджання — для
...
| `sensor.eveus_ev_charger_cost_to_target_soc` | грн | — | — | **Вартість до цільового заряду** — прогноз вартості з урахуванням тарифних вікон станції |
