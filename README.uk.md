...
- **Керування:** натискання на показник відкриває сутність. Довге натискання на плитку батареї або Alt+Enter, коли вона у фокусі, відкриває **Початковий SOC**; так само плитка цілі відкриває **Цільовий SOC**. Для зупинки активного заряджання натисніть **Стоп** повторно протягом чотирьох секунд. Збільшення струму теж потребує підтвердження: натисніть на нове значення протягом чотирьох секунд, щоб застосувати його; зменшення застосовується одразу. Скидання лічильника картка перепитує. У **Розкладах** натисніть на час, щоб вибрати новий, на значок ліміту — щоб увімкнути чи вимкнути його, а на значення — щоб ввести нове. Значок розкладу світиться, коли за годинником станції розклад діє. Якщо **Зміщення часу** невідоме або годинник станції відхиляється від Home Assistant на 10 хвилин чи більше, картка приховує підсвічення розкладу й час його наступного початку.
