...
| `full` | Усе з `control`, а також параметри SOC. Лише в Розширеному режимі — у Базовому параметрів SOC немає, тож він показує те саме, що `control` | Усе з `control`, а також **Початковий SOC**, **Цільовий SOC**, **Ємність батареї**, **Корекція SOC** |
