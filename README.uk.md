...
Картка є частиною інтеграції. Параметр `layout` визначає її вигляд і доступні
...
| `status` | Заряд, час до цільового заряду, струм, енергія й вартість сесії, потужність і напруга, стан | — (лише перегляд) |
